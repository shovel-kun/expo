 ...
 */
export function convertFormData(formData: FormData): { body: string; boundary: string } {
 ...
 */
export function normalizeHeadersInit(headers: HeadersInit | null | undefined): [string, string][] {
  if (headers == null) {
    return [];
  }
